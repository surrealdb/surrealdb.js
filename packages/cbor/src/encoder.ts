...
function encode(input: unknown, options?: EncoderOptions<true>): PartiallyEncoded;
function encode(input: unknown, options: EncoderOptions = {}): PartiallyEncoded | Uint8Array {
