...
export class AgentMemoryError extends Error {
    override readonly name: string = "AgentMemoryError";
...
export class AuthError extends AgentMemoryError {
    override readonly name: string = "AuthError";
}

/** Principal or scope floor rejected the call (403). */
export class ScopeError extends AgentMemoryError {
...
export class RateLimitError extends AgentMemoryError {
    ...
    constructor(
        options: ConstructorParameters<typeof AgentMemoryError>[0] & { retryAfter?: number | null },
    ) {
        super(options);
...
export class ServerError extends AgentMemoryError {
    override readonly name: string = "ServerError";
}

/** Network failure, timeout, or other non-HTTP error (status 0). */
export class ConnectionError extends AgentMemoryError {
 ...
 */
export class CancelledError extends AgentMemoryError {
    override readonly name: string = "CancelledError";
}

type ErrorCtor = new (
    args: ConstructorParameters<typeof AgentMemoryError>[0],
) => InstanceType<typeof AgentMemoryError>;
