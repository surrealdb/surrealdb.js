...
> {
     ...
     * @returns A new `UpsertPromise` configured to retry on conflict.
     */
    retry(options: boolean | Partial<RetryOptions> = true): UpsertPromise<T, I, J> {
     ...
     */
    patch(data: Patch[]): UpsertPromise<T, I, J> {
        return new UpsertPromise<T, I, J>(this.#connection, {
            ...this.#options,
            mutation: "patch",
            data,
