...
import { output } from "../../internal/collect";
...
export class SurrealV2 implements EventPublisher<SurrealV2Events> {
     ...
     */
    public rpc<Result>(method: string, params?: unknown[]): Promise<RpcResponse<Result>> {
    ...
    async live(what: LiveResource, diff?: boolean): Promise<LiveSubscription> {
        await this.ready;
        return new ManagedLiveSubscription(this.#publisher, this.#connection, what, diff ?? false);
    }
     ...
     */
    async query<T extends unknown[]>(prepared: PreparedQuery, gaps?: Fill[]): Promise<Prettify<T>>;
    ...
    // Shadow implementation
    async create<T extends Doc, U extends Doc = T>(what: RecordId | Table, data?: U) {
        await this.ready;
     ...
     */
    async insert<T extends Doc, U extends Doc = T>(data?: U | U[]): Promise<ActionResult<T>[]>;
    ...
    // Shadow implementation
    async insert<T extends Doc, U extends Doc = T>(arg1: Table | U | U[], arg2?: U | U[]) {
        await this.ready;
    ...
    // Shadow implementation
    async insertRelation<T extends Doc, U extends Doc = T>(arg1: Table | U | U[], arg2?: U | U[]) {
        await this.ready;
        const params = arg1 instanceof Table ? [arg1, arg2] : [undefined, arg1];
    ...
    async patch(what: RecordId | RecordIdRange | Table, data?: Patch[], diff?: boolean) {
        await this.ready;
    ...
    async run(name: string, arg2?: string | unknown[], arg3?: unknown[]) {
        await this.ready;
        const [version, args] = Array.isArray(arg2) ? [undefined, arg2] : [arg2, arg3];
