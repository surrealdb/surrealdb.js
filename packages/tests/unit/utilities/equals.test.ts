...
import { BoundExcluded, BoundIncluded, equals, RecordId, RecordIdRange } from "surrealdb";
...
describe("equals()", () => {
    ...
    test("record id ranges", () => {
        const first = new RecordIdRange("alphabet", new BoundIncluded("a"), new BoundExcluded("z"));
