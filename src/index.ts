...
export default class Surreal extends Emitter {
  ...
  select<T>(thing: string): Promise<T[]> {
    ...
    return this.wait().then(() => {
      return new Promise((resolve, reject) => {
        this.once(
          id,
          (res) => this.#output(res, "select", thing, resolve, reject),
        );
  ...
  create<T extends object>(
    ...
    return this.wait().then(() => {
      return new Promise((resolve, reject) => {
        this.once(
          id,
          (res) => this.#output(res, "create", thing, resolve, reject),
        );
  ...
  update<T extends object>(
    ...
    return this.wait().then(() => {
      return new Promise((resolve, reject) => {
        this.once(
          id,
          (res) => this.#output(res, "update", thing, resolve, reject),
        );
  ...
  change<T extends object, U extends object = T>(
    thing: string,
    data?: Partial<T> & U,
    ...
    return this.wait().then(() => {
      return new Promise((resolve, reject) => {
        this.once(
          id,
          (res) => this.#output(res, "change", thing, resolve, reject),
        );
  ...
  modify(thing: string, data?: Patch[]): Promise<Patch[]> {
    ...
    return this.wait().then(() => {
      return new Promise((resolve, reject) => {
        this.once(
          id,
          (res) => this.#output(res, "modify", thing, resolve, reject),
        );
  ...
  delete(thing: string): Promise<void> {
    ...
    return this.wait().then(() => {
      return new Promise((resolve, reject) => {
        this.once(
          id,
          (res) => this.#output(res, "delete", thing, resolve, reject),
        );
