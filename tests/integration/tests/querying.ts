...
import { Decimal, Duration, GeometryCollection, GeometryLine, GeometryMultiPolygon, GeometryPoint, GeometryPolygon, RecordId, Table, UUID, uuidv4, uuidv7 } from "../../../mod.ts";
...
Deno.test("query", async () => {
	...
	const input = {
		...
		rid: new RecordId("some-custom", ["recordid", { with_an: "object" }, undefined]),
